                ...
                <div className="bg-white rounded-2xl shadow-[0_4px_32px_rgba(94,67,216,0.12)] p-8">
                    {!showMFA ? (
                        ...
                        <>
                            ...
                            <div className="mb-5 p-3 rounded-xl flex items-center gap-3 bg-[#EDE8FB] border border-[#5E43D8]/20">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#5E43D8]">
                                    <Shield className="w-4 h-4 text-white" />
                                </div>
                                <div>
                                    <p className="text-xs text-[#2D1B6B] font-semibold">
                                        {pendingRole === 'COSEC' ? 'CoSec Admin' : 'Board Director'}
                                    </p>
                                    <p className="text-xs text-[#2D1B6B]/50">
                                        Routing to → /auth/select-role
                                    </p>
                                </div>
                            </div>
